...
namespace SPE.Engine
{
    public static class ColourHandler
    {
        ...
        {
            return AllColours.FirstOrDefault(x => x.Hex.Equals(hex));
        }

        public static Colour ByRgb(int r, int g, int b)
        {
            return AllColours.FirstOrDefault(x => x.R == r && x.G == g && x.B == b);
        }

        public static Colour ByRgb(int r, int b, int g, int a)
        {
            return AllColours.FirstOrDefault(x => x.R == r && x.G == g && x.B == b && x.A == a);
        }

        public static Colour ByCode(short code)
        {
            return AllColours.FirstOrDefault(x => x.Code == code);
        }
